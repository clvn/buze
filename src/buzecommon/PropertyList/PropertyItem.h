...
#define PIN_ITEMDELETE          (PIN_FIRST-10)
...
#define WM_USER_PROP_DELETEPROPERTY   WM_USER+437
#endif // WM_USER_PROP_xxx

// Custom control messages sent to In-place edit
#ifndef WM_USER_PROPEDIT_ISEDITDIRTY
#define WM_USER_PROPEDIT_ISEDITDIRTY  WM_USER+440
#endif // WM_USER_PROPEDIT_xxx
