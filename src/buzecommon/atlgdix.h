...
public:
   ...
   CMemDC(HDC hDC, LPRECT pRect = NULL)
   {
	  ...
	  CSize windowExt, viewportExt;
	  m_dc.GetWindowExt(&windowExt);
	  m_dc.GetViewportExt(&viewportExt);
	  SetWindowExt(windowExt.cx, windowExt.cy);
	  SetViewportExt(viewportExt.cx, viewportExt.cy);
